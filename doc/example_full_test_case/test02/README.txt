...
python2 project_fast.py nuage load doc\example_full_test_case\test02\nuage_topology.json
...
python2 project_fast.py ixchariot load doc\example_full_test_case\test02\ixchariot_test02_vteps.json
