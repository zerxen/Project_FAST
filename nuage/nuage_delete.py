...
def nuage_delete(args):
    ...
    if args.OBJECT == 'enterprise':
        ...
        if args.tree == 1:
            nuage.delete_whole_enterprise_tree(args.entname[0])
        else:
            nuage.delete_enterprise(args.entname[0])
    ...
    if args.OBJECT == 'user':
        ...
        nuage = nuage_vspk_wrapper();
        nuage.connect()  
        nuage.delete_user(args.entname[0],args.username[0])
    ...
    if args.OBJECT == 'group':
        ...
        nuage = nuage_vspk_wrapper();
        nuage.connect()  
        nuage.delete_group(args.entname[0],args.groupname[0])        
    ...
    if args.OBJECT == 'domaintemplate':   
        ...
        nuage = nuage_vspk_wrapper();
        nuage.connect()        
        nuage.delete_domain_template(args.entname[0],args.domtempname[0])   
    ...
    if args.OBJECT == 'domain':   
        ...
        nuage = nuage_vspk_wrapper();
        nuage.connect()        
        nuage.delete_domain(args.entname[0],args.domname[0])  
    ...
    if args.OBJECT == 'zone':   
        ...
        nuage = nuage_vspk_wrapper();
        nuage.connect()        
        nuage.delete_zone(args.entname[0],args.domname[0],args.zonename[0])  
    ...
    if args.OBJECT == 'subnet':   
        ...
        nuage = nuage_vspk_wrapper();
        nuage.connect()        
        nuage.delete_subnet(args.entname[0],args.domname[0],args.zonename[0],args.subnetname[0])  
